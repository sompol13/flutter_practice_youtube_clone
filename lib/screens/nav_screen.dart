    ...
    return Scaffold(
      body: Consumer(
        builder: (context, watch, _) {
          ...
          final miniplayController = watch(miniplayerControllerProvider).state;
          return Stack(
                      ...
                      return Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            const LinearProgressIndicator(value: 0.4, valueColor: AlwaysStoppedAnimation<Color>(Colors.red),)
                          ],
                        ),
                      );
                    }
